        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="md:py-8">
            <div className="mb-2 md:mb-3">
              <span className="mg-0.5 inline-block text-gray-500">
                {data.categoryName}
              </span>
            ...
            <div className="mb-4">
              <div className="flex items-end gap-2 ">
                ...
                <span className="mb-0.5 font-semibold text-red-500 line-through">
                  ${data.price + 30}
                </span>
              </div>
              <span className="text-sm text-gray-500">
                Inclusive of all taxs.
              </span>
            </div>
            ...
            <p
            className="mt-12 text-base text-gray-500 tracking-wide">{data.description}</p>
          </div>
        </div>
      </div>
    </div>
